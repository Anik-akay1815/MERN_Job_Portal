...
function PostJobs() {
  ...
  const inputClass =
    "w-full bg-white/80 dark:bg-[#161c2e]/75 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm text-slate-800 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-blue-400/20 focus:border-blue-400 dark:focus:border-[#7cc2f2] transition";
  const selectClass = `${inputClass} cursor-pointer`;
  const labelClass =
    "block text-xs font-semibold text-slate-600 dark:text-slate-400 mb-2";
          ...
          <div className="hidden lg:block sticky top-24 rounded-3xl overflow-hidden bg-[#10182b] text-white border border-white/10 shadow-2xl">
            ...
            <div className="relative p-8">
              <div className="flex items-center gap-3 mb-10">
                <div className="w-11 h-11 rounded-xl bg-linear-to-br from-blue-500 to-indigo-600 flex items-center justify-center font-bold text-lg shadow-lg shadow-blue-500/20">
                  C
                </div>
                <div>
                  <h2 className="text-xl font-bold">Careerly</h2>
                  <p className="text-[10px] tracking-[0.2em] text-slate-400">
                    FIND · CONNECT · GROW
                  </p>
                </div>
              </div>
              <span className="inline-flex items-center gap-2 bg-white/10 text-blue-200 border border-white/10 px-3 py-1.5 rounded-full text-xs font-semibold">
                <Icon name="briefcase" size={14} />{" "}
                {id ? "Edit position" : "Create a position"}
              </span>
              <h1 className="text-3xl font-bold leading-tight mt-6">
                {id
                  ? "Keep your job post up to date."
                  : "Reach the right talent with a better job post."}
              </h1>
              <p className="text-sm text-slate-300 leading-relaxed mt-4">
                Give candidates the information they need to understand the
                role, your expectations, and why they should apply.
              </p>
              ...
              <div className="mt-9 space-y-5">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold">Clear role details</p>
                    <p className="text-xs text-slate-400 mt-0.5">
                      Title, salary, type and location
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      Help the right candidates find you
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold">Better applications</p>
                    <p className="text-xs text-slate-400 mt-0.5">
                      Set expectations before candidates apply
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10 pt-6 border-t border-white/10">
                ...
                <p className="text-sm text-slate-300 mt-2">
                  Create focused listings that are easier to discover and easier
                  to trust.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                  <span className="inline-flex items-center gap-1.5 bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-400/20 px-3 py-1.5 rounded-full text-xs font-semibold">
                    <Icon name="file" size={14} /> Job details
                  </span>
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    {id
                      ? "Review and update the information candidates see."
                      : "Create a professional listing and start attracting candidates."}
                  </p>
                </div>
                <div className="hidden sm:flex items-center gap-2 text-xs text-slate-400 dark:text-slate-500">
                  <span className="w-2 h-2 rounded-full bg-emerald-500" /> All
            ...
            <form className="p-6 md:p-8 space-y-7" onSubmit={handleSubmit}>
              <section>
                <div className="flex items-center gap-2 mb-4">
                  <span className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-300 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-500">
                      Start with the basics of the role.
                    </p>
                  </div>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      <option
                        value=""
                        className="bg-white dark:bg-[#161c2e] text-slate-800 dark:text-white"
                      >
                        Select Category
                      </option>
              ...
              <section className="pt-6 border-t border-slate-200/70 dark:border-white/10">
                <div className="flex items-center gap-2 mb-4">
                  <span className="w-8 h-8 rounded-lg bg-purple-50 dark:bg-purple-500/10 text-purple-600 dark:text-purple-300 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-500">
                      Help candidates understand the opportunity.
                    </p>
                  </div>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
              ...
              <section className="pt-6 border-t border-slate-200/70 dark:border-white/10">
                <div className="flex items-center gap-2 mb-4">
                  <span className="w-8 h-8 rounded-lg bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-300 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-500">
                      Choose the skills you want candidates to have.
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  {jobData.skillsRequired.length > 0 ? (
                      ...
                      <div className="flex flex-wrap gap-2">
                        {jobData.skillsRequired.map((skill) => (
                          <button
                            ...
                            key={skill}
                            onClick={() => toggleSkill(skill)}
                            className="inline-flex items-center gap-1.5 bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-400/20 px-3 py-1.5 rounded-lg text-xs font-semibold hover:bg-red-50 hover:text-red-600 hover:border-red-200 dark:hover:bg-red-500/10 dark:hover:text-red-300 dark:hover:border-red-400/20 transition cursor-pointer"
                          >
                            {skill}
                    ...
                    <div className="mt-3 text-xs text-slate-400 dark:text-slate-500">
                      Select skills from any category. You can mix Frontend,
                      Backend, Data, DevOps and other skills.
                    </div>
                  )}
                </div>
              ...
              <section className="pt-6 border-t border-slate-200/70 dark:border-white/10">
                <div className="flex items-center gap-2 mb-4">
                  <span className="w-8 h-8 rounded-lg bg-teal-50 dark:bg-teal-500/10 text-teal-600 dark:text-teal-300 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-500">
                      Give candidates enough context to make an informed
                      decision.
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full bg-linear-to-r from-blue-500 via-indigo-600 to-purple-600 hover:from-blue-600 hover:via-indigo-700 hover:to-purple-700 transition-all duration-300 font-bold text-white py-3.5 rounded-xl cursor-pointer shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/25"
                >
                  {id ? "Update Job" : "Publish Job"}
                </button>
                <p className="text-center text-xs text-slate-400 dark:text-slate-500 mt-3">
                  Your listing will be visible to candidates after publishing.
                </p>
              </div>
            </form>
          </div>
          ...
          <div className="w-full max-w-md bg-white/95 dark:bg-[#161c2e]/95 backdrop-blur-xl border border-white/70 dark:border-white/10 rounded-2xl p-6 shadow-2xl">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">
              {id
                ...
                : "Are you sure you want to publish this new job posting?"}
            </p>
