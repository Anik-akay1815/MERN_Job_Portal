      ...
      <section className="min-h-[60vh] bg-linear-to-br from-slate-50 via-gray-50 to-emerald-50">
        <div className="flex flex-col items-center justify-center text-center py-24 max-w-screen-2xl mx-auto px-6">
          ...
          <h1 className="text-5xl font-bold leading-tight text-gray-900">
            Find Your
            <span className="text-slate-700"> Dream Job</span>
          </h1>
          ...
          <form
            ...
            className="mt-10 flex w-full max-w-3xl bg-white shadow-xl rounded-xl overflow-hidden border border-gray-200"
          >
            {/* Keyword */}
            <input
              type="text"
            ...
            <button
              type="submit"
              className="bg-emerald-500 m-1.5 text-white px-10 py-3.5 font-semibold rounded-lg hover:bg-emerald-600 transition-all duration-300 shadow-md hover:shadow-lg"
            >
              Search
            </button>
          </form>
